...
namespace RPGCharacterAnims
{
    ...
    public class RPGCharacterWeaponController:MonoBehaviour
    {
        ...
        {
            //Set audio manager new and old weapon numbers
            RPG_Character_Weapon_AudioManager audioManager = GetComponentInChildren<RPG_Character_Weapon_AudioManager>();
            audioManager.newWeaponNumber = weaponNumber;
            audioManager.currentRightWeaponNumber = rightWeapon;
            audioManager.currentLeftWeaponNumber = leftWeapon;
