...
namespace RPGCharacterAnims
{
    public class GUIControls:MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            buttonHeight = Screen.height / 23;
            buttonWidth = Screen.width / 13;
        }
        ...
        private void OnGUI()
        {
			...
			if(!rpgCharacterController.isDead && rpgCharacterMovementController.rpgCharacterState != RPGCharacterState.ClimbLadder && rpgCharacterMovementController.rpgCharacterState != RPGCharacterState.Swim)
			{
				...
				if(rpgCharacterController.canAction)
				{
					...
					if(rpgCharacterMovementController.MaintainingGround())
					{
						...
						//Blocking.
						blockGui = GUI.Toggle(new Rect(Screen.width / 50, Screen.height / 5 + (buttonHeight * 13), buttonWidth, buttonHeight), blockGui, "Block");
						if(blockGui)
						{
							if(!blockToggle)
							{
						...
						if(blockGui)
						{
							if(GUI.Button(new Rect(Screen.width / 50, Screen.height / 5 + (buttonHeight * 11), buttonWidth, buttonHeight), "Get Hit"))
							{
						...
						{
							//Rolling.
							if(GUI.Button(new Rect(Screen.width / 50, Screen.height / 23, buttonWidth, buttonHeight), "Roll Forward"))
							{
								StartCoroutine(rpgCharacterMovementController._Roll(1));
							}
							if(GUI.Button(new Rect(Screen.width / 10, Screen.height / 23, buttonWidth, buttonHeight), "Roll Backward"))
							{
								StartCoroutine(rpgCharacterMovementController._Roll(3));
							}
							if(GUI.Button(new Rect(Screen.width / 50, Screen.height / 12, buttonWidth, buttonHeight), "Roll Left"))
							{
								StartCoroutine(rpgCharacterMovementController._Roll(4));
							}
							if(GUI.Button(new Rect(Screen.width / 10, Screen.height / 12, buttonWidth, buttonHeight), "Roll Right"))
							{
							...
							if(rpgCharacterController.weapon == Weapon.SHIELD || rpgCharacterController.weapon != Weapon.ARMED || (rpgCharacterController.weapon == Weapon.ARMED && rpgCharacterWeaponController.leftWeapon != 0) && rpgCharacterWeaponController.leftWeapon != 7)
							{
                                ...
                                {
                                    if (GUI.Button(new Rect(Screen.width / 50, Screen.height / 5, buttonWidth, buttonHeight), "Attack"))
                                    {
							...
							if(rpgCharacterController.weapon != Weapon.RELAX && rpgCharacterMovementController.MaintainingGround())
							{
								...
								{
									if(GUI.Button(new Rect(Screen.width / 10, Screen.height / 5, buttonWidth, buttonHeight), "Special Attack1"))
									{
							...
							if(!rpgCharacterMovementController.isMoving)
							{
								if(rpgCharacterController.weapon != Weapon.RELAX)
								{
									if(GUI.Button(new Rect(Screen.width / 10, Screen.height / 5 + (buttonHeight * 2), buttonWidth, buttonHeight), "Relax"))
									{
								...
								{
									if(GUI.Button(new Rect(Screen.width / 50, Screen.height / 5 + (buttonHeight * 2), buttonWidth, buttonHeight), "Unarmed"))
									{
								...
								{
									if(GUI.Button(new Rect(Screen.width / 50, Screen.height / 5 + (buttonHeight * 8), buttonWidth, buttonHeight), "2 Hand Sword"))
									{
										StartCoroutine(rpgCharacterWeaponController._SwitchWeapon(1));
									}
								}
								...
								{
									if(GUI.Button(new Rect(Screen.width / 50, Screen.height / 5 + (buttonHeight * 10), buttonWidth, buttonHeight), "2 Hand Spear"))
									{
								...
								{
									if(GUI.Button(new Rect(Screen.width / 50, Screen.height / 5 + (buttonHeight * 9), buttonWidth, buttonHeight), "2 Hand Axe"))
									{
								...
								{
									if(GUI.Button(new Rect(Screen.width / 50, Screen.height / 5 + (buttonHeight * 11), buttonWidth, buttonHeight), "2 Hand Bow"))
									{
								...
								{
									if(GUI.Button(new Rect(Screen.width / 50, Screen.height / 5 + (buttonHeight * 7), buttonWidth, buttonHeight), "Crossbow"))
									{
								...
								{
									if(GUI.Button(new Rect(Screen.width / 50, Screen.height / 5 + (buttonHeight * 6), buttonWidth, buttonHeight), "Staff"))
									{
								...
								{
									if(GUI.Button(new Rect(Screen.width / 50, Screen.height / 5 + (buttonHeight * 3), buttonWidth, buttonHeight), "Left Sword"))
									{
								...
								{
									if(GUI.Button(new Rect(Screen.width / 50, Screen.height / 5 + (buttonHeight * 5), buttonWidth, buttonHeight), "Left Mace"))
									{
								...
								{
									if(GUI.Button(new Rect(Screen.width / 50, Screen.height / 5 + (buttonHeight * 4), buttonWidth, buttonHeight), "Left Dagger"))
									{
					...
					if((rpgCharacterMovementController.canJump || rpgCharacterMovementController.canDoubleJump) && !blockGui && rpgCharacterController.canAction)
					{
						if(rpgCharacterMovementController.MaintainingGround())
						{
							if(GUI.Button(new Rect(Screen.width / 10, Screen.height / 5 + (buttonHeight * 3), buttonWidth, buttonHeight), "Jump"))
							{
						...
						{
							if(GUI.Button(new Rect(Screen.width / 10, Screen.height / 5 + (buttonHeight * 3), buttonWidth, buttonHeight), "Jump Flip"))
							{
					...
					{
						if(GUI.Button(new Rect(Screen.width / 50, Screen.height / 5 + (buttonHeight * 14), buttonWidth, buttonHeight), "Death"))
						{
				...
				if(rpgCharacterController.weapon != Weapon.RELAX && !rpgCharacterController.canAction)
				{
					if(rpgCharacterController.weapon == Weapon.TWOHANDSWORD || rpgCharacterController.weapon == Weapon.TWOHANDAXE || rpgCharacterController.weapon == Weapon.TWOHANDSPEAR || rpgCharacterController.weapon == Weapon.STAFF)
					{
						if(GUI.Button(new Rect(Screen.width / 10, Screen.height / 5, buttonWidth, buttonHeight), "End Special"))
						{
							rpgCharacterController.Special(1);
						}
					}
			...
			{
				if(GUI.Button(new Rect(Screen.width / 50, Screen.height / 5 + (buttonHeight * 9), buttonWidth, buttonHeight), "Swim Up"))
				{
					rpgCharacterMovementController.SwimAscend();
				}
				if(GUI.Button(new Rect(Screen.width / 50, Screen.height / 5 + (buttonHeight * 11), buttonWidth, buttonHeight), "Swim Down"))
				{
			...
			{
				if(GUI.Button(new Rect(Screen.width / 50, Screen.height / 5 + (buttonHeight * 14), buttonWidth, buttonHeight), "Revive"))
				{
